            ...
            <div className="page-header">
                <div className="header-left">
                    <div className="title-section">
                        ...
                        <p className="page-subtitle">{projects.length} {projects.length === 1 ? 'проект' : 'проектов'}</p>
                    </div>
                    ...
                    {filteredProjects.map(project => (
                        <div key={project.id} className="project-card-enhanced" onClick={() => navigate(`/projects/${project.id}`)}>
                            ...
                            <div className="card-info-grid">
                                ...
                                <div className="info-col">
                                    <div className="info-label">🏙️ Город</div>
                                ...
                                <div className="info-col">
                                    <div className="info-label">🗺️ Регион</div>
                            ...
                            <div className="card-footer">
                                <div className="responsible-preview">
                                    <span className="resp-label">МП:</span>
